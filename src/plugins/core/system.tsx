...
import { HotkeysShortcutPanel } from "@/plugins/core/panels/system/hotkeys-shortcut-panel";
import { SettingsShortcutPanel } from "@/plugins/core/panels/system/settings-shortcut-panel";
...
export function createCoreSystemPlugin(): CorePluginDescriptor {
  return {
    ...
    name: "Core System",
    version: "0.1.0",
    permissions: ["settings.read", "settings.write", "window.mode"],
    panels: [createSettingsPanel(), createHotkeysPanel()],
  };
}
